    ...
    <div style={{marginTop:'50px'}}>
        <center>
            ...
            <div style={{marginTop:'60px',lineHeight:'2'}}>
                <input type='text'  placeholder='Enter your name' name='name' value={formdata.name} onChange={handleChange}/><br/><br/>
                <input type='number' placeholder='Enter your age' name='number'  value={formdata.number} onChange={handleChange}/><br/><br/>
